<?php $paginatorOptions = $this->get('paginator.options', [
    'limit' => [
        'show' => true,
        'options' => [
            20 => 20,
        ...
        <div class="record-counter">
            <?php if (!empty($paginatorOptions['limit']['show'])) : ?>
                <?= $this->Form->control('limit', [
                    ...
                    'default' => $this->getRequest()->getQuery('limit') ? $this->getRequest()->getQuery('limit') : $paginatorOptions['limit']['options'][20] ?? 20,
                    'templates' => [
